...
class RecipeEditor extends StatefulWidget {
  ...
  @override
  RecipeEditorState createState() => RecipeEditorState();
}

class RecipeEditorState extends State<RecipeEditor> {
              ...
              for (var i = 0;
                ...
                items.add(
                  Padding(
                    ...
                    child: TextField(
                      onSubmitted: (text) {
                        recipes.editVarName(widget.recipeId, index, i, text);
                      },
                      controller: TextEditingController(
                        text: recipes.variationName(widget.recipeId, index, i),
                      ),
            ...
            children: [
              Expanded(
                child: PageView(
                  ...
                  onPageChanged: (id) => setState(() => page = id),
                  children: [
                    ingredientsPage,
                    variationsPage,
